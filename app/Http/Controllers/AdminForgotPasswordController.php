...
class AdminForgotPasswordController extends \crocodicstudio\crudbooster\controllers\CBController
{
    public function cbInit()
    {
        ...
        $this->form[] = ['label'=>'Tutorial ID', 'name'=>'content_id', 'type'=>'wysiwyg', 'validation'=>'required', 'width'=>'col-sm-10'];
        $this->form[] = ['label'=>'Tutorial EN', 'name'=>'content_en', 'type'=>'wysiwyg', 'validation'=>'required', 'width'=>'col-sm-10'];
    ...
    */
    ...
    {
        $logDesc      = 'Edit Forgot Password';
        $content      = Content::findOrFail($id)->toArray();
        insertRhapsodieLog($logDesc, 'forgot_password', CRUDBooster::myId(), json_encode(array_diff($postdata, $content)));
    }
    ...
    */
    ...
    {
        \Cache::forget('forgot_tutorial');
        CRUDBooster::redirectBack('Berhasil menyimpan Forgot Password', 'success');
    }
    ...
    */
    ...
    public function getIndex()
    {
        ...
        $id = Content::where('type', 'forgot_password')->first();
        return redirect()->route('AdminForgotPasswordControllerGetEdit', ['id'=>$id]);
    }
}
