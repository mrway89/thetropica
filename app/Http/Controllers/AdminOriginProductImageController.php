...
class AdminOriginProductImageController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    */
    ...
    {
        $postdata['type']       = 'origin_product_image';
    }
    ...
    */
    ...
    public function getIndex()
    {
        ...
        $images = DB::table('images')->where('item_id', \Request::get('parent_id'))->where('type', 'origin_product_image')->orderby('sorting', 'asc')->get();

        $return_url = Request::fullUrl();

        $page_title = 'Origin Product Image';

        return view('vendor/crudbooster/origin_product_image', compact('images', 'return_url', 'page_title'));
    }
}
