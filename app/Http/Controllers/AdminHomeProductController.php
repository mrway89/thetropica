...
class AdminHomeProductController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    */
    ...
    public function getIndex()
    {
        ...
        $images = DB::table('images')->where('type', 'home_product')->orderby('sorting', 'asc')->get();

        $return_url = Request::fullUrl();

        $page_title = 'Home Product Management';

        return view('vendor/crudbooster/home_product', compact('images', 'return_url', 'page_title'));
    }
