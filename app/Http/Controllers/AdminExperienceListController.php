...
class AdminExperienceListController extends \crocodicstudio\crudbooster\controllers\CBController
{
    public function cbInit()
    {
        ...
        $this->col[] = ['label'=>'slug', 'name'=>'slug', 'visible' => false];
        // END COLUMNS DO NOT REMOVE THIS LINE

        // START FORM DO NOT REMOVE THIS LINE
        $this->form   = [];
        $this->form[] = ['label'=>'Image', 'name'=>'image', 'type'=>'upload', 'validation'=>'required|image', 'width'=>'col-sm-10', 'help'=>'File types support : JPG, JPEG, PNG, GIF, BMP', 'upload_encrypt' => 'true'];
        $this->form[] = ['label'=>'Title ID', 'name'=>'title_id', 'type'=>'text', 'validation'=>'', 'width'=>'col-sm-10'];
        $this->form[] = ['label'=>'Subtitle ID', 'name'=>'subtitle_id', 'type'=>'text', 'validation'=>'', 'width'=>'col-sm-10', 'datatable'=>'subtitle,id'];
        $this->form[] = ['label'=>'Content ID', 'name'=>'content_id', 'type'=>'textarea', 'validation'=>'', 'width'=>'col-sm-10', 'datatable'=>'content,id'];
        $this->form[] = ['label'=>'Title EN', 'name'=>'title_en', 'type'=>'text', 'validation'=>'', 'width'=>'col-sm-10'];
        $this->form[] = ['label'=>'Subtitle EN', 'name'=>'subtitle_en', 'type'=>'text', 'validation'=>'', 'width'=>'col-sm-10'];
        ...
        */
        $this->sub_module   = [];
        $this->sub_module[] = ['label' => 'Details', 'path' => 'experience_retreat', 'foreign_key' => 'parent_id', 'button_color' => 'info', 'button_icon' => 'fa fa-list', 'parent_columns' => 'title_id', 'custom_parent_alias' => 'Title', 'showIf' => "[slug] == 'retreat'"];
        $this->sub_module[] = ['label' => 'Details', 'path' => 'factory_visit', 'foreign_key' => 'parent_id', 'button_color' => 'warning', 'button_icon' => 'fa fa-list', 'parent_columns' => 'title_id', 'custom_parent_alias' => 'Title', 'showIf' => "[slug] == 'factory-visit'"];
        $this->sub_module[] = ['label' => 'Camps', 'path' => 'camps', 'foreign_key' => 'parent_id', 'button_color' => 'danger', 'button_icon' => 'fa fa-list', 'parent_columns' => 'title_id', 'custom_parent_alias' => 'Title', 'showIf' => "[slug] == 'camp-with-us'"];
        $this->sub_module[] = ['label' => 'Content', 'path' => 'experience_camp_contents', 'foreign_key' => 'parent_id', 'button_color' => 'primary', 'button_icon' => 'fa fa-list', 'showIf' => "[slug] == 'camp-with-us'"];
    ...
    */
    ...
    {
        $query->where('type', 'experience_list');
    }
    ...
    */
    public function hook_before_add(&$postdata)
    {
        ...
        // $count                  = ExperienceContent::where('type', 'experience_list')->count();
        // $slug                   = str_slug($postdata['title_id']);
        // $checkSlug              = ExperienceContent::where('type', 'experience_list')->where('slug', $slug)->get()->count();
        // if ($checkSlug > 0) {
        //     $slug = $slug . '-' . str_random(5);
        // }
        // $postdata['slug']       = $slug;
        // $postdata['type']       = 'experience_list';
