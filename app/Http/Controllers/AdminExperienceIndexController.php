...
class AdminExperienceIndexController extends \crocodicstudio\crudbooster\controllers\CBController
{
    public function cbInit()
    {
        ...
        $this->col[] = ['label'=>'Title', 'name'=>'title_id'];
        ...
        $this->form[] = ['label'=>'Content ID', 'name'=>'content_id', 'type'=>'textarea', 'validation'=>'required|string', 'width'=>'col-sm-10'];
        $this->form[] = ['label'=>'Content EN', 'name'=>'content_en', 'type'=>'textarea', 'validation'=>'required|string', 'width'=>'col-sm-10'];
    ...
    */
    ...
    public function getIndex()
    {
        ...
        $images = DB::table('experience_contents')->where('type', 'index')->get();

        $return_url = Request::fullUrl();

        $page_title = 'Experience Index';

        return view('vendor/crudbooster/experience_index', compact('images', 'return_url', 'page_title'));
    }
}
