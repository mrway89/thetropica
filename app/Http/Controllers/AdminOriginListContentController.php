...
class AdminOriginListContentController extends \crocodicstudio\crudbooster\controllers\CBController
{
    public function cbInit()
    {
        ...
        $this->form[] = ['label'=>'Content ID', 'name'=>'content_id', 'type'=>'wysiwyg', 'width'=>'col-sm-9', 'validation'=>'required'];
        $this->form[] = ['label'=>'Content EN', 'name'=>'content_en', 'type'=>'wysiwyg', 'width'=>'col-sm-9', 'validation'=>'required'];
    ...
    */
    ...
    {
        $query->where('type', 'origin_map_content');
    }
    ...
    */
    public function hook_before_add(&$postdata)
    {
        ...
        $postdata['type']       = 'origin_map_content';
    }
    ...
    */
    public function hook_after_add($id)
    {
        ...
        $logDesc                = 'Add new Origin List Content ' . $image->url;
        insertRhapsodieLog($logDesc, 'origin_map_content', CRUDBooster::myId(), $image->url);
    }
    ...
    */
    public function hook_before_edit(&$postdata, $id)
    {
        ...
        $image                  = Image::findOrFail($id);
        $logDesc                = 'Edit Origin List Content ' . $image->url;
        insertRhapsodieLog($logDesc, 'origin_map_content', CRUDBooster::myId(), json_encode($postdata));
    }
    ...
    */
    ...
    {
        \Cache::forget('origin_map_content');
    }
    ...
    */
    ...
    public function getIndex()
    {
        ...
        $images = DB::table('images')->where('type', 'origin_map_content')->orderby('sorting', 'asc')->get();

        $return_url = Request::fullUrl();

        $page_title = 'Origin List Content Management';

        return view('vendor/crudbooster/origin_map_content', compact('images', 'return_url', 'page_title'));
    }
}
