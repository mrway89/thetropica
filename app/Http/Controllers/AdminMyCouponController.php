...
class AdminMyCouponController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    */
    ...
    {
        CRUDBooster::redirectBack('Content My Point Successfully Saved', 'success');
    }
    ...
    */
    ...
    public function getIndex()
    {
		...
		$id = Content::where('type', 'my_coupon')->first();

        return redirect()->route('AdminMyCouponControllerGetEdit', ['id'=>$id]);
    }
}
