...
class AdminShippingImagesController extends \crocodicstudio\crudbooster\controllers\CBController
{
    public function cbInit()
    {
        ...
        $this->form   = [];
        $this->form[] = ['label' => 'Image', 'name' => 'url', 'type' => 'upload', 'validation' => 'required|image|max:1000', 'upload_encrypt' => 'true', 'width' => 'col-sm-10', 'help' => 'Best resolution: 51 x 31px, Max file Size: 1 Mb'];
        ...
        //$this->form[] = ["label"=>"Url","name"=>"url","type"=>"text","required"=>TRUE,"validation"=>"required|url","placeholder"=>"Mohon masukkan URL yang benar"];
        //$this->form[] = ["label"=>"Is Featured","name"=>"is_featured","type"=>"radio","required"=>TRUE,"validation"=>"required|integer","dataenum"=>"Array"];
        //$this->form[] = ["label"=>"Link","name"=>"link","type"=>"text","required"=>TRUE,"validation"=>"required|url","placeholder"=>"Mohon masukkan URL yang benar"];
    ...
    */
    ...
    {
        //Your code here
        $query->where('type', 'footer_shipping');
    }
