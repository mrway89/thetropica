...
class AdminOriginContentController extends \crocodicstudio\crudbooster\controllers\CBController
{
    public function cbInit()
    {
        ...
        $this->form   = [];
        $this->form[] = ['label' => 'Image', 'name' => 'url', 'type' => 'upload', 'validation' => 'required|image|max:1000', 'upload_encrypt' => 'true', 'width' => 'col-sm-10', 'help' => 'Best resolution: 1920 x 1080px, Max file Size: 1 Mb'];
        $this->form[] = ['label' => 'Title ID', 'name' => 'title_id', 'type' => 'text', 'width' => 'col-sm-9', 'validation' => 'required'];
        $this->form[] = ['label' => 'Title EN', 'name' => 'title_en', 'type' => 'text', 'width' => 'col-sm-9', 'validation' => 'required'];
        $this->form[] = ['label' => 'Subtitle ID', 'name' => 'subtitle_id', 'type' => 'text', 'width' => 'col-sm-9'];
        $this->form[] = ['label' => 'Subtitle EN', 'name' => 'subtitle_en', 'type' => 'text', 'width' => 'col-sm-9'];
        ...
        $this->form[] = ['label' => 'item_id', 'name' => 'item_id', 'type' => 'hidden', 'width' => 'col-sm-9', 'value' => \Request::get('parent_id')];
    ...
    */
    public function hook_after_add($id)
    {
        ...
        $logDesc                = 'Add new home origin ' . $image->url;
        insertRhapsodieLog($logDesc, 'home_origin', CRUDBooster::myId(), $image->url);
    }
    ...
    */
    public function hook_before_edit(&$postdata, $id)
    {
        ...
        $image                  = Image::findOrFail($id);
        $logDesc                = 'Edit origin ' . $image->url;
        insertRhapsodieLog($logDesc, 'origin_slides', CRUDBooster::myId(), json_encode($postdata));
    }
    ...
    */
    ...
    public function getIndex()
    {
        ...
        $images = DB::table('images')->where('item_id', \Request::get('parent_id'))->where('type', 'origin_slides')->orderby('sorting', 'asc')->get();

        $return_url = Request::fullUrl();

        $page_title = 'Origin Slide Content Management';

        return view('vendor/crudbooster/origin_btm_content', compact('images', 'return_url', 'page_title'));
    }
