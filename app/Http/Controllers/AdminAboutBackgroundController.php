...
class AdminAboutBackgroundController extends \crocodicstudio\crudbooster\controllers\CBController
{
    public function cbInit()
    {
        ...
        $this->form   = [];
        $this->form[] = ['label'=>'Section', 'name'=>'title_id', 'type'=>'text', 'width'=>'col-sm-9', 'placeholder' => '', 'help' => '', 'disabled'=> true];
    ...
    */
    ...
    {
        $query->where('type', 'about_background');
    }
    ...
    */
    ...
    {
        $postdata['type']       = 'about_background';
    }
    ...
    */
    public function hook_after_add($id)
    {
        ...
        $logDesc                = 'Add new home banner ' . $image->url;
        \Cache::forget('about_backgrounds');
        insertRhapsodieLog($logDesc, 'about_background', CRUDBooster::myId(), $image->url);
    }
    ...
    */
    public function hook_before_edit(&$postdata, $id)
    {
        ...
        $image                  = Image::findOrFail($id);
        $logDesc                = 'Edit Home banner ' . $image->url;
        insertRhapsodieLog($logDesc, 'about_background', CRUDBooster::myId(), json_encode($postdata));
    }
    ...
    */
    ...
    public function getIndex()
    {
        ...
        $images = DB::table('images')->where('type', 'about_background')->orderby('sorting', 'asc')->get();

        $return_url = Request::fullUrl();

        $page_title = 'About Background Management';

        return view('vendor/crudbooster/about_background', compact('images', 'return_url', 'page_title'));
    }
