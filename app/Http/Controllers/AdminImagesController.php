...
class AdminImagesController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    */
    ...
    {
        $query->where('type', 'footer_payment');
    }
