...
class AdminHomeOriginController extends \crocodicstudio\crudbooster\controllers\CBController
{
    public function cbInit()
    {
        ...
        $this->form   = [];
        $this->form[] = ['label' => 'Image', 'name' => 'url', 'type' => 'upload', 'validation' => 'image|max:1000', 'upload_encrypt' => 'true', 'width' => 'col-sm-10', 'help' => 'Best resolution: 2000 x 663px, Max file Size: 1 Mb'];
        $this->form[] = ['label' => 'Url Text ID', 'name' => 'title_id', 'type' => 'text', 'width' => 'col-sm-9', 'validation' => ''];
        $this->form[] = ['label' => 'Url Text EN', 'name' => 'title_en', 'type' => 'text', 'width' => 'col-sm-9', 'validation' => ''];
    ...
    */
    public function hook_after_add($id)
    {
        ...
        $logDesc                = 'Add new home product ' . $image->url;
        insertRhapsodieLog($logDesc, 'home_product', CRUDBooster::myId(), $image->url);
    }
    ...
    */
    public function hook_before_edit(&$postdata, $id)
    {
        ...
        $image                  = Image::findOrFail($id);
        $logDesc                = 'Edit Home product ' . $image->url;
        insertRhapsodieLog($logDesc, 'home_product', CRUDBooster::myId(), json_encode($postdata));
    }
    ...
    */
    ...
    public function getIndex()
    {
        ...
        $images = DB::table('images')->where('type', 'home_origin')->orderby('sorting', 'asc')->get();

        $return_url = Request::fullUrl();

        $page_title = 'Home Product Management';

        return view('vendor/crudbooster/home_origin', compact('images', 'return_url', 'page_title'));
    }
