...
class AdminPrivacyPolicyController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    */
    ...
    {
        $logDesc      = 'Edit privacy policy';
        $content      = Content::findOrFail($id)->toArray();
        insertRhapsodieLog($logDesc, 'privacy_policy', CRUDBooster::myId(), json_encode(array_diff($postdata, $content)));
    }
    ...
    */
    ...
    {
        CRUDBooster::redirectBack('Berhasil menyimpan Privacy Policy', 'success');
    }
    ...
    */
    ...
    public function getIndex()
    {
        ...
        $id = Content::where('type', 'privacy_policy')->first();
        return redirect()->route('AdminPrivacyPolicyControllerGetEdit', ['id'=>$id]);
    }
}
