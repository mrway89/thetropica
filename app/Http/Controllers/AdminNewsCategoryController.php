...
class AdminNewsCategoryController extends \crocodicstudio\crudbooster\controllers\CBController
{
    public function cbInit()
    {
        ...
        $this->col   = [];
        $this->col[] = ['label' => 'Category Name ID', 'name' => 'title_id'];
        $this->col[] = ['label' => 'Category Name EN', 'name' => 'title_en'];
        // END COLUMNS DO NOT REMOVE THIS LINE

        // START FORM DO NOT REMOVE THIS LINE
        $this->form   = [];
        $this->form[] = ['label' => 'Category Name ID', 'name' => 'title_id', 'type' => 'text', 'validation' => 'required', 'width' => 'col-sm-10'];
        $this->form[] = ['label' => 'Category Name EN', 'name' => 'title_en', 'type' => 'text', 'validation' => 'required', 'width' => 'col-sm-10'];
    ...
    */
    public function hook_before_add(&$postdata)
    {
        ...
        $checkSlug              = Category::where('type', 'news')->where('slug', str_slug($postdata['title']))->get()->count();
    ...
    */
    public function hook_after_add($id)
    {
        ...
        $logDesc      = 'Add new news category ' . $how->title_en;
        insertRhapsodieLog($logDesc, 'news_category', CRUDBooster::myId(), $how->toJson());
    }
    ...
    */
    public function hook_before_edit(&$postdata, $id)
    {
        ...
        $slug                   = str_slug($postdata['title_en']);
        $checkSlug              = Category::where('type', 'news')->where('id', '!=', $id)->where('slug', str_slug($postdata['title_en']))->get()->count();
        ...
        $logDesc          = 'Edit news category ' . $content->title_en;
        insertRhapsodieLog($logDesc, 'news_category', CRUDBooster::myId(), json_encode(array_diff($postdata, $content->toArray())));
    }
    ...
    */
    ...
    {
        // $content          = Category::findOrFail($id);
        // $logDesc          = 'Delete news category ' . $content->title;
        // insertRhapsodieLog($logDesc, 'news_category', CRUDBooster::myId(), $content->toJson());
    }
