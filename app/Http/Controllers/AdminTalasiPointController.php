...
class AdminTalasiPointController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    */
    ...
    {
        CRUDBooster::redirectBack('Content Talasi Point Successfully Saved', 'success');
    }
    ...
    */
    ...
    public function getIndex()
    {
        ...
        $id = Content::where('type', 'talasi_point')->first();

        return redirect()->route('AdminTalasiPointControllerGetEdit', ['id'=>$id]);
    }
}
