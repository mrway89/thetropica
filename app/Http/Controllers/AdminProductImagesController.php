...
class AdminProductImagesController extends \crocodicstudio\crudbooster\controllers\CBController
{
    public function cbInit()
    {
        ...
        $this->form[] = ['label' => 'Image', 'name' => 'url', 'type' => 'upload', 'validation' => 'required|image|max:1000', 'upload_encrypt' => 'true', 'width' => 'col-sm-10', 'help' => 'Best resolution: 400 x 700px, Max file Size: 1 Mb'];
        $this->form[] = ['label' => 'Thumbnail', 'name' => 'thumbnail', 'type' => 'upload', 'validation' => 'image|max:1000', 'upload_encrypt' => 'true', 'width' => 'col-sm-10', 'help' => 'Best resolution: 400 x 400px, Max file Size: 1 Mb'];
        $this->form[] = ['label' => 'Title ID', 'name' => 'title_id', 'type' => 'text', 'validation' => '', 'width' => 'col-sm-10', 'help' => ''];
        $this->form[] = ['label' => 'Title EN', 'name' => 'title_en', 'type' => 'text', 'validation' => '', 'width' => 'col-sm-10', 'help' => ''];
    ...
    */
    ...
    {
        $query->where('type', 'product')->where('item_id', request('parent_id'));
    }
    ...
    */
    ...
    {
        $count                  = Image::where('type', 'product')->where('item_id', $postdata['item_id'])->get()->count();
    ...
    */
    public function hook_after_add($id)
    {
        ...
        $logDesc = 'Add new image to product ' . $image->product->name;
    ...
    */
    ...
    public function getIndex()
    {
        ...
        $images = DB::table('images')->where('type', 'product')->where('item_id', request('parent_id'))->orderby('sorting', 'asc')->get();
        ...
        return view('vendor/crudbooster/product_images_management', compact('images', 'return_url', 'page_title', 'submenu'));
    }
