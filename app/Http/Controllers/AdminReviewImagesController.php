...
class AdminReviewImagesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Product Review Id","name"=>"product_review_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"product_review,id"];
	    ...
	    */
		...
		public function getIndex()
		{
			...
			$images = DB::table('product_review_images')->where('product_review_id', request('parent_id'))->get();

			$submenu =  ProductReview::findOrFail(request('parent_id'));

			$return_url = Request::fullUrl();

			$page_title = 'Review Images Management for ' . $submenu->name;

			return view('vendor/crudbooster/review_images', compact('images', 'return_url', 'page_title', 'submenu'));
		}
