...
class AdminUserAgreementController extends \crocodicstudio\crudbooster\controllers\CBController
{
	...
	public function cbInit()
	{
		...
		$this->col[] = ["label" => "Content Id", "name" => "content_id"];
		$this->col[] = ["label" => "Content En", "name" => "content_en"];
	...
	{
		$query->where('type', 'user_agreement')->first();
	}
	...
	public function getIndex()
	{
		...
		$id = Content::where('type', 'user_agreement')->first();
		return redirect()->route('AdminUserAgreementControllerGetEdit', ['id' => $id]);
	}
}
