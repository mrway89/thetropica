...
class AdminStaticContentController extends \crocodicstudio\crudbooster\controllers\CBController
{
	...
	public function cbInit()
	{
		...
		$this->col[] = ['label' => 'Link', 'name' => 'slug', 'callback' => function ($row) {
			return '<a href="' . route('frontend.static.content', $row->slug) . '" target="_blank">Link</a>';
		}];
		# END COLUMNS DO NOT REMOVE THIS LINE

		# START FORM DO NOT REMOVE THIS LINE
		$this->form = [];
		$this->form[] = ['label' => 'type', 'name' => 'type', 'type' => 'hidden', 'value' => 'static_content'];
		$this->form[] = ['label' => 'Title ID', 'name' => 'title_id', 'type' => 'text', 'validation' => 'required', 'width' => 'col-sm-10'];
		$this->form[] = ['label' => 'Title EN', 'name' => 'title_en', 'type' => 'text', 'validation' => 'required', 'width' => 'col-sm-10'];
		...
		//$this->form[] = ["label"=>"Content En","name"=>"content_en","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	...
	{
		$query->where('type', 'static_content');
	}
	...
	public function hook_before_add(&$postdata)
	{
		...
		$checkSlug              = Post::where('type', 'static_content')->where('slug', str_slug($postdata['title_en']))->get()->count();
	...
	public function hook_before_edit(&$postdata, $id)
	{
		...
		$slug                   	= str_slug($postdata['title_en']);
		$checkSlug              	= Post::where('type', 'static_content')->where('id', '!=', $id)->where('slug', str_slug($postdata['title_en']))->get()->count();
