...
class AdminPopupsController extends \crocodicstudio\crudbooster\controllers\CBController
{
	...
	public function cbInit()
	{
		...
		$this->form[] = ['label' => 'Url', 'name' => 'url', 'type' => 'text', 'validation' => '', 'width' => 'col-sm-10', 'placeholder' => 'Please enter a valid URL'];
		$this->form[] = ['label' => 'Start Date', 'name' => 'start_date', 'type' => 'date', 'validation' => 'required|date_format:Y-m-d', 'width' => 'col-sm-10'];
		$this->form[] = ['label' => 'End Date', 'name' => 'end_date', 'type' => 'date', 'validation' => 'required|date_format:Y-m-d', 'width' => 'col-sm-10'];
		...
		//$this->form[] = ["label"=>"Publish","name"=>"publish","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
		# OLD END FORM
