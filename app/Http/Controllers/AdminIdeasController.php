...
class AdminIdeasController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    */
    ...
    {
        $postdata['created_at'] = Carbon::parse($postdata['created_at'])->format('Y-m-d');
        $postdata['updated_at'] = Carbon::parse($postdata['updated_at'])->format('Y-m-d');
    }
