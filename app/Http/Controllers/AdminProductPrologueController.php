...
class AdminProductPrologueController extends \crocodicstudio\crudbooster\controllers\CBController
{
    public function cbInit()
    {
        ...
        $this->form[] = ['label'=>'Subtitle ID', 'name'=>'subtitle_id', 'type'=>'text', 'width'=>'col-sm-9', 'validation'=>''];
        $this->form[] = ['label'=>'Subtitle EN', 'name'=>'subtitle_en', 'type'=>'text', 'width'=>'col-sm-9', 'validation'=>''];
    ...
    */
    ...
    {
        $query->where('type', 'product_prologue');
    }
    ...
    */
    public function hook_before_add(&$postdata)
    {
        ...
        $postdata['type']       = 'product_prologue';
    }
    ...
    */
    public function hook_after_add($id)
    {
        ...
        $logDesc                = 'Add new product prologue ' . $image->url;
    ...
    */
    public function hook_before_edit(&$postdata, $id)
    {
        ...
        $image                  = Image::findOrFail($id);
        $logDesc                = 'Edit product prologue ' . $image->url;
    ...
    */
    ...
    public function getIndex()
    {
        ...
        $images = DB::table('images')->where('type', 'product_prologue')->orderby('sorting', 'asc')->get();

        $return_url = Request::fullUrl();

        $page_title = 'product prologue Management';

        return view('vendor/crudbooster/product_prologue', compact('images', 'return_url', 'page_title'));
    }
}
