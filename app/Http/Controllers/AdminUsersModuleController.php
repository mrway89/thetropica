...
class AdminUsersModuleController extends \crocodicstudio\crudbooster\controllers\CBController
{
    public function cbInit()
    {
        ...
        $this->form[] = [
            ...
            'datatable_where'    => 'name != "Maha Dewa"',
            'required'           => true,
            'relationship_table' => 'cms_privileges',
        ];
