...
<body>
	<nav class="{{Request::segment(2) != 'about' && Request::segment(2) != 'origin' && Request::segment(2) != 'product' && Request::segment(2) != 'experience' && Request::segment(2) != '' && Request::segment(2) != 'home' ? 'bg-white border-bottom':'bg-transparent' }} navbar navbar-expand-md fixed-top px-5 headerzindex d-none d-lg-flex" >
			...
			<div class="navbar-collapse collapse justify-content-center order-2 w-100" id="collapsingNavbar">
		        <ul class="navbar-nav">
		            <li class="nav-item {{Request::segment(2) == 'about'? 'active':'' }}">
		                <a class="nav-link" href="{{url('frontend/about')}}">About Talasi</a>
		            </li>
		            <li class="nav-item {{Request::segment(2) == 'product'? 'active':'' }}">
					<a class="nav-link" href="{{url('frontend/product')}}">Product</a>
		            </li>
		            <li class="nav-item {{Request::segment(2) == 'origin'? 'active':'' }}">
		                <a class="nav-link" href="#">Origin</a>
		            </li>
		            <li class="nav-item {{Request::segment(2) == 'experience'? 'active':'' }}">
	...
	<nav class="navbar navbar-expand-md header-mobile fixed-top px-2 d-flex d-lg-none {{Request::segment(2) == 'about' || Request::segment(2) == 'origin'   && Request::segment(2) == '' && Request::segment(2) == 'home'? 'bg-transparent':'bg-white' }} ">
		<div class="container-fluid">
			<div class="row w-100 m-0">
				<div class="col-3">
					<i onclick="openNav()" class="fa fa-bars change-color {{Request::segment(2) == 'about'? 'text-white':'text-grey' }}  icon-nav mt-2" aria-hidden="true"></i>
				</div>
				...
				<div class="col-3">
					<ul class="list-inline list-header-right float-right">
						...
						<li class="list-inline-item">
							...
							{{Request::segment(2) == 'account' || Request::segment(2) == 'compare-product'
					...
					{{-- <a href="#" class="pull-right change-color {{Request::segment(2) == 'about'? 'text-white':'text-grey' }} mt-3 bold-700" title="">
						ENG
					</a> --}}
				</div>
			</div>
