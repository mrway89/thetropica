	...
	<div id="talasi-carousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner home-carousel">
            <div class="carousel-item active">
                <img src="{{ asset('assets/img/maxresdefault.png') }}" class="d-block w-100" alt="...">
                <div class="carousel-caption caption-experience-slide text-left">
                    <h1>Behind the Scenes: Discover How Talasi</h1>
                    ...
                    <div class="mt-4">
						<a href="#"><button class="btn-border-white px-3 py-2 pointer btn-letsgo mr-3 d-none">GET MORE DETAILED GUIDE</button></a>
			...
			<div class="carousel-item">
                <img src="{{ asset('assets/img/Fabrika-2.png') }}" class="d-block w-100" alt="...">
				<div class="carousel-caption caption-experience-slide text-left">
                    <h1>Behind the Scenes: Discover How Talasi</h1>
                    <p>Get a taste of how we convert the natural richness of Bali into nourishments for your body and soul with our factory visit and retreat experience.</p>
                    <div class="mt-4">
			...
			<div class="carousel-item">
                <img src="{{ asset('assets/img/modern-equipment-at-the-food-factory-automatic-conveyer-production-line-of-ice-cream-cones_hhem1dkdu__F0000.png') }}" class="d-block w-100" alt="...">
				<div class="carousel-caption caption-experience-slide text-left">
                    <h1>Behind the Scenes: Discover How Talasi</h1>
                    <p>Get a taste of how we convert the natural richness of Bali into nourishments for your body and soul with our factory visit and retreat experience.</p>
                    <div class="mt-4">             
