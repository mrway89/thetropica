	...
	<div id="talasi-carousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner home-carousel">
            <div class="carousel-item active">
                <img src="{{ asset('assets/img/drew-coffman-SmJvTwiGTjs-unsplash.png') }}" class="d-block w-100" alt="...">
                <div class="carousel-caption caption-experience-slide text-left">
                    <h1>Come, Enjoy and Make Memories in Our Cozy Space</h1>
                    ...
                    <div class="mt-4">             
                        <a href="{{url('frontend/experience/detail-retreat')}}"><button class="btn-border-white px-3 py-2 pointer btn-letsgo mr-3">OUR MENU</button></a>
			...
			<div class="carousel-item">
                <img src="{{ asset('assets/img/dogancan-ozturan-94taEmdowRw-unsplash.png') }}" class="d-block w-100" alt="...">
				<div class="carousel-caption caption-experience-slide text-left">
                    <h1>Come and Share</h1>
                    <p>Get a taste of how we convert the natural richness of Bali into nourishments for your body and soul with our factory visit and retreat experience.</p>
                    <div class="mt-4">             
                        <a href="{{url('frontend/experience/detail-retreat')}}"><button class="btn-border-white px-3 py-2 pointer btn-letsgo mr-3">OUR MENU</button></a>
						<a href="#"><button class="btn-border-white px-3 py-2 pointer btn-letsgo d-none">EXPLORE TALASI’S SPACE</button></a>
			...
			<div class="carousel-item">
                <img src="{{ asset('assets/img/bence-balla-schottner-k3PN_7R3FcA-unsplash.png') }}" class="d-block w-100" alt="...">
				<div class="carousel-caption caption-experience-slide text-left">
                    <h1>While Enjoying</h1>
                    <p>Get a taste of how we convert the natural richness of Bali into nourishments for your body and soul with our factory visit and retreat experience.</p>
                    <div class="mt-4">             
                        <a href="{{url('frontend/experience/detail-retreat')}}"><button class="btn-border-white px-3 py-2 pointer btn-letsgo mr-3">OUR MENU</button></a>
						<a href="#"><button class="btn-border-white px-3 py-2 pointer btn-letsgo d-none">EXPLORE TALASI’S SPACE</button></a>
