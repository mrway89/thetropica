...
@section('content')
<div class="section fp-table detret" style="background: url({{asset('assets/img/IMG_20190502_085320.png')}});
            ...
            <div class="col-md-9 text-white text-left">
                ...
                <div class="row mt-4 justify-content-start">
                    <div class="col-md-3 col-6 mb-3">
                        <a href="{{url('frontend/experience/camp-us-list')}}"><button class="btn-border-white w-100 px-3 py-2 pointer btn-letsgo mr-3">TALASI SUMBA CAMP</button></a>
                    </div>
                    <div class="col-md-3 col-6 mb-3">
                        <a href="{{url('frontend/experience/camp-us-list')}}"><button class="btn-border-white w-100 px-3 py-2 pointer btn-letsgo">TALASI BALI CAMP</button></a>
                    </div>
                    <div class="col-md-3 col-6 mb-3">
