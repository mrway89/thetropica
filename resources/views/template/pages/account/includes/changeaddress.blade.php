      ...
      <div class="modal-body pt-5 pb-2">
        ...
        <form action="" method="get" accept-charset="utf-8">
          <div class="form-group row">
            <div class="col-12">
                <input type="text" class="form-control radius-0 mb-5 input-bg-search" id="city-state" placeholder="Change Address">
            </div>
          </div>
        </form>
        ...
        <div class="row">
          <div class="col-12 mb-5">
              ...
              <a href="#" class="bold-700" title="" data-dismiss="modal" data-toggle="modal" data-target="#editAddress">Edit Address</a>
                <span class="mx-2">|</span>
                <a href="#" class="bold-700" title="">Edit Pinpoint</a>
              </div> 
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-12 mb-5">
              <a href="#" title="" data-dismiss="modal" data-toggle="modal" data-target="#addAddress">Add New Address +</a>
          </div>
        </div> 
