...
<div class="modal fade" id="addAddress" tabindex="-1" role="dialog" aria-labelledby="addAddressLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        ...
        <div class="modal-body">
            ...
            <form action="{{ route('frontend.ajax.multi.save.address') }}" method="POST" id="address_form_modal">
            {{ csrf_field() }}
            <input type="hidden" name="product" value="" id="product_id_form">
            ...
            <div class="form-group row justify-content-end">
                ...
                <div class="col-5">
                    <button type="submit" class="btn btn-primary btn-send-about w-100" id="btn_new_address">ADD & USE ADDRESS</button>
                </div>
            </div>
