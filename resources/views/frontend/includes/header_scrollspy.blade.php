<body>
	<nav class="{{Request::segment(1) != 'about' && Request::segment(1) != '' && Request::segment(1) != 'product' && Request::segment(1) != 'experience' && Request::segment(1) != 'home' ? 'bg-white':'bg-transparent bg-gradient' }} navbar navbar-expand-md fixed-top px-5 hidden-992">

		<div class="container-fluid">
			<div class="d-flex w-40 order-0">
				<a class="navbar-brand brandlogwhite mr-1" href="{{ route('frontend.home') }}">
					<img src="{{ asset($company_logo_header) }}" class="img-logo-small" alt="Talasi Logo">
		        </a>
			...
			<div class="navbar-collapse collapse justify-content-center order-2 w-100" id="collapsingNavbar">
				<ul class="navbar-nav" id="navbar-scroll">
				   <li class="nav-item">
					...
					<!--<li class="nav-item" data-menuanchor="product">
						<a class="nav-link bordered" href="{{ route('frontend.product.brand') }}">{{ $trans['navigation_product'] }}</a>
					</li>
					<li class="nav-item" data-menuanchor="origin">
						<a class="nav-link bordered" href="{{ route('frontend.origin.index') }}">{{ $trans['navigation_origin'] }}</a>
					</li>
							...
							<div class="dropdown-menu dropdown-search-md" aria-labelledby="dropdownMenu1">
								<form  action="{{ route('frontend.product.search') }}"  accept-charset="utf-8">
									...
									<div class="input-group mb-3">
										<input type="text" name="search" class="form-control" placeholder="" aria-label="Recipient's username" aria-describedby="button-addon2">
	...
	<nav class="navbar navbar-expand-md header-mobile fixed-top px-2 visible-992 bg-white">
		<div class="container-fluid d-flex flex-column">
			...
			<div class="searchbox-head w-100 mx-auto my-0">
				<form action="{{ route('frontend.product.search') }}" method="get" accept-charset="utf-8">
					<div class="input-group">
						<div class="input-group-append">
							<button class="btn btn-search-md-x" type="button" id="button-addon2"><img src="{{ asset('assets/img/magnifying-glass.png') }}"></button>
						</div>
						<input type="text" name="search" class="form-control input-search-x pl-2 pt-2" placeholder="Search talasi.co.id" aria-label="Recipient's username"
