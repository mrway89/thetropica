            ...
            $(function () {
                ...
                var sortactive = $(".draggable-menu").sortable({
                    ...
                    onDrop: function ($item, container, _super) {
                        ...
                        $.post("{{route('AdminAboutUsControllerPostSaveSorting')}}", {images: jsonString, item_id: item_id}, function (resp) {
                            ...
                            <li data-id='{{$image->id}}'>
                                <div class='position-relative' title="" style="text-align: center;">
                                    ...
                                    <span class='edit-icon'>
                                        <a class='fa fa-pencil text-white' title='Edit' href='{{route("AdminAboutUsControllerGetEdit",["id"=>$image->id])}}?return_url={{urlencode(Request::fullUrl())}}' style="; background: #00a65a;"></a>

                                        <a title='Delete' class='fa fa-trash text-white' onclick='{{CRUDBooster::deleteConfirm(route("AdminAboutUsControllerGetDelete",["id"=>$image->id]))}}' href='javascript:void(0)'></a>
                                    </span>
