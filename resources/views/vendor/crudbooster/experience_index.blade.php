    ...
    @push('bottom')
        ...
        <script type="text/javascript">
            $(function () {
                ...
                //         $.post("{{route('AdminHomeBannerControllerPostSaveSorting')}}", {images: jsonString, item_id: item_id}, function (resp) {
        ...
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    ...
                    <strong>Experience Content</strong> <span id='menu-saved-info' style="display:none" class='pull-right text-success'><i class='fa fa-check'></i> Image Saved !</span>
                </div>
                            ...
                            <li data-id='{{$image->id}}'>
                                <div class='position-relative' title="" style="text-align: center;">
                                    ...
                                    <span class='edit-icon'>
                                        ...
                                        <a class='fa fa-pencil text-white' title='Edit' href='{{route("AdminExperienceIndexControllerGetEdit",["id"=>$image->id])}}?return_url={{urlencode(Request::fullUrl())}}'></a>
                                        {{-- &nbsp;&nbsp; --}}
