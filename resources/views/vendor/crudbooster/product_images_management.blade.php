            ...
            $(function () {
                ...
                var sortactive = $(".draggable-menu").sortable({
                    ...
                    onDrop: function ($item, container, _super) {
                        ...
                        $.post("{{route('AdminProductImagesControllerPostSaveSorting')}}", {images: jsonString, item_id: item_id}, function (resp) {
                ...
                $('.set_default').on('click', function() {
                    var id          = $(this).data('id');
                    var defaultUrl  = '{{route('AdminProductImagesControllerPostSetDefault')}}';
                            ...
                            <li data-id='{{$image->id}}'>
                                <div class='' title="" style='text-align: center;'>
                                    ...
                                    <span class='pull-right'>
                                        ...
                                        <a class='fa fa-pencil text-white' title='Edit' href='{{route("AdminProductImagesControllerGetEdit",["id"=>$image->id])}}?return_url={{urlencode(Request::fullUrl())}}'></a>
                                        &nbsp;&nbsp;
                                        <a title='Delete' class='fa fa-trash' onclick='{{CRUDBooster::deleteConfirm(route("AdminProductImagesControllerGetDelete",["id"=>$image->id]))}}' href='javascript:void(0)'></a>
                                    </span>
                                </div>
                            </li>
                        @endforeach
