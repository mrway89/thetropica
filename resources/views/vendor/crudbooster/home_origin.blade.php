                            ...
                            <li data-id='{{$image->id}}'>
                                <div class='position-relative' title="" style="text-align: center;">
                                    ...
                                    <span class='edit-icon'>
                                        ...
                                        &nbsp;&nbsp; --}}
                                        <a class='fa fa-pencil text-white' title='Edit' href='{{route("AdminHomeOriginControllerGetEdit",["id"=>$image->id])}}?return_url={{urlencode(Request::fullUrl())}}' style="; background: #00a65a;"></a>
