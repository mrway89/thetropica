            ...
            $(function () {
                ...
                var sortactive = $(".draggable-menu").sortable({
                    ...
                    onDrop: function ($item, container, _super) {
                        ...
                        $.post("{{route('AdminAboutBackgroundControllerPostSaveSorting')}}", {images: jsonString, item_id: item_id}, function (resp) {
        ...
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    ...
                    <strong>About Background</strong> <span id='menu-saved-info' style="display:none" class='pull-right text-success'><i class='fa fa-check'></i> Image Saved !</span>
                </div>
                            ...
                            <li data-id='{{$image->id}}'>
                                <div class='position-relative' title="" style="text-align: center;">
                                    ...
                                    <span class='edit-icon'>
                                        ...
                                        <a class='fa fa-pencil text-white' title='Edit' href='{{route("AdminAboutBackgroundControllerGetEdit",["id"=>$image->id])}}?return_url={{urlencode(Request::fullUrl())}}'></a>
                                        {{-- &nbsp;&nbsp; --}}
                                        {{-- <a title='Delete' class='fa fa-trash' onclick='{{CRUDBooster::deleteConfirm(route("AdminAboutBackgroundControllerGetDelete",["id"=>$image->id]))}}' href='javascript:void(0)'></a> --}}
                                    </span>
