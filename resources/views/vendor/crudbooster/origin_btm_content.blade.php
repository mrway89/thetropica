            ...
            $(function () {
                ...
                var sortactive = $(".draggable-menu").sortable({
                    ...
                    onDrop: function ($item, container, _super) {
                        ...
                        $.post("{{route('AdminOriginContentControllerPostSaveSorting')}}", {images: jsonString, item_id: item_id}, function (resp) {
                ...
                $('.set_default').on('click', function() {
                    var id          = $(this).data('id');
                    var defaultUrl  = '{{route('AdminOriginContentControllerPostSetDefault')}}';
                            ...
                            <li data-id='{{$image->id}}'>
                                <div class='position-relative' title="" style="text-align: center;">
                                    ...
                                    <span class='edit-icon'>
                                        ...
                                        &nbsp;&nbsp; --}}
                                        <a class='fa fa-pencil text-white' title='Edit' href='{{route("AdminOriginContentControllerGetEdit",["id"=>$image->id])}}?return_url={{urlencode(Request::fullUrl())}}' style="; background: #00a65a;"></a>
                                        &nbsp;
                                        <a title='Delete' class='fa fa-trash text-white' onclick='{{CRUDBooster::deleteConfirm(route("AdminOriginContentControllerGetDelete",["id"=>$image->id]))}}' href='javascript:void(0)'></a>
                                    </span>
                                    <br>
                                    <span class="banner-content">
                                        <b>ID : {{ $image->title_id ? $image->title_id : 'Empty title' }}</b><br>
                                        <b>EN : {{ $image->title_en ? $image->title_en : 'Empty title' }}</b><br>
